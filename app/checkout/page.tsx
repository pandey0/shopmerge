...
export default function CheckoutPage() {
  ...
  if (!apparel || !size) {
    return (
      <div className="h-screen bg-black text-white flex flex-col items-center justify-center p-6 text-center">
        ...
        <h1 className="text-xl font-black italic tracking-tighter uppercase mb-2">Session Expired</h1>
        <p className="text-xs tracking-widest uppercase text-white/40 mb-8">The checkout link is no longer valid</p>
        <button
          onClick={() => router.push("/")}
  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white selection:bg-white selection:text-black">
      {/* BACKGROUND ORB - Adds depth for premium feel */}
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-32 pb-24">
        ...
        >
          ...
          <span className="text-[10px] font-bold tracking-[0.2em] uppercase">Back to Studio</span>
        </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-16 xl:gap-24 items-start">
          ...
          <div className="order-1 lg:order-2 lg:sticky lg:top-32">
             ...
             {/* MOBILE-ONLY SUMMARY PREVIEW */}
             <div className="lg:hidden mb-12 p-6 rounded-[2rem] bg-white/[0.03] border border-white/10 flex items-center justify-between">
                <div>
                  <p className="text-[10px] font-bold tracking-widest text-white/40 uppercase mb-1">Your Selection</p>
                  <p className="text-lg font-black italic tracking-tighter uppercase">{apparel} / {size}</p>
                </div>
                <div className="text-right">
                  <p className="text-2xl font-light">${apparel === 'tee' ? '34' : '54'}</p>
                </div>
             </div>
          </div>
